...
public enum TaxStatusEnum {
  ...
  static {
    ...
    openapiFields.add("low_stock_amount");
    openapiFields.add("brands");
    openapiFields.add("has_options");
    openapiFields.add("post_password");
    openapiFields.add("global_unique_id");
    openapiFields.add("permalink_template");
    openapiFields.add("generated_slug");
    openapiFields.add("jetpack_sharing_enabled");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Product.openapiFields.contains(entry.getKey())) {
            Logger.getLogger(Product.class.getName()).log(Level.WARNING,
                String.format("The field `%s` in the JSON string is not defined in the `Product` properties. JSON: %s, due to plugins this could be as expected",
                    entry.getKey(),
      ...
      if ((jsonObj.get("low_stock_amount") != null && !jsonObj.get("low_stock_amount").isJsonNull()) && !jsonObj.get("low_stock_amount").isJsonPrimitive()) {
          throw new IllegalArgumentException(String.format("Expected the field `low_stock_amount` to be a primitive type in the JSON string but got `%s`", jsonObj.get("low_stock_amount").toString()));
      }
      if ((jsonObj.get("has_options") != null && !jsonObj.get("has_options").isJsonNull()) && !jsonObj.get("has_options").isJsonPrimitive()) {
          throw new IllegalArgumentException(String.format("Expected the field `has_options` to be a primitive type in the JSON string but got `%s`", jsonObj.get("has_options").toString()));
      }

      if ((jsonObj.get("post_password") != null && !jsonObj.get("post_password").isJsonNull()) && !jsonObj.get("post_password").isJsonPrimitive()) {
          throw new IllegalArgumentException(String.format("Expected the field `post_password` to be a primitive type in the JSON string but got `%s`", jsonObj.get("post_password").toString()));
      }
      String v = "global_unique_id";
      if ((jsonObj.get(v) != null && !jsonObj.get(v).isJsonNull()) && !jsonObj.get(v).isJsonPrimitive()) {
          throw new IllegalArgumentException(String.format("Expected the field `%s` to be a primitive type in the JSON string but got `%s`", v, jsonObj.get(v).toString()));
      }
      v = "permalink_template";
      if ((jsonObj.get(v) != null && !jsonObj.get(v).isJsonNull()) && !jsonObj.get(v).isJsonPrimitive()) {
          throw new IllegalArgumentException(String.format("Expected the field `%s` to be a primitive type in the JSON string but got `%s`", v, jsonObj.get(v).toString()));
      }
      v = "generated_slug";
      ...
      if ((jsonObj.get(v) != null && !jsonObj.get(v).isJsonNull())) {
          JsonArray jsonArrayBrands = jsonObj.getAsJsonArray(v);
          if (jsonArrayBrands != null) {
              // ensure the json data is an array
              if (!jsonObj.get(v).isJsonArray()) {
                  throw new IllegalArgumentException(String.format("Expected the field `%s` to be an array in the JSON string but got `%s`", v, jsonObj.get(v).toString()));
              }
      ...
      v = "_links";
      if ((jsonObj.get(v) != null && !jsonObj.get(v).isJsonNull())) {
          Links.validateJsonElement(jsonObj.get(v));
      }
  ...
  public String toJson() {
      ...
      System.out.println(JSON.getGson().toJson(this));
