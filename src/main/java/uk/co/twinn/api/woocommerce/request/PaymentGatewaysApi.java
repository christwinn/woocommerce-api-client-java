...
public class PaymentGatewaysApi extends ApiRequest {

    private final PaymentGateway paymentGateway = new PaymentGateway();

    public PaymentGatewaysApi(){}

    private PaymentGatewaysApi(Updater<?> updater){
    ...
    public Updater<?> update(String gatewayId){

        return new Updater<>(gatewayId);

    }

    public Reader<?> read(String gatewayId){

        return new Reader<>(gatewayId);
    ...
    public static class Updater<T extends Updater<T>>{
        ...
        private PaymentGatewaysApi build(){
            return new PaymentGatewaysApi(this);
        }

        public Updated<PaymentGateway> getResponse(){
            if (gatewayId != null && !gatewayId.isEmpty()){

                PaymentGatewaysApi create = build();
                return new Updated<>(
