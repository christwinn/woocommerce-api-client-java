...
public class ShippingMethod {
    ...
    private String id; //	string	Method ID.read-only
    private String title; //	string	Shipping method title.read-only
    private String description; //string	Shipping method description.read-on
